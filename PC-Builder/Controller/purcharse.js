...
// mensaje = document.querySelector("h2");

// mensaje.innerText=sessionStorage.getItem("mobo");

console.log(sessionStorage.getItem("mobo"));
imgsrc = sessionStorage.getItem("mobo");
// img = document.querySelector("img");
// img.src=imgsrc;
description = document.querySelector("p");
description.innerText=imgsrc;
